...
# A character string cannot actually be modeled. When the string is made into a factor, 
# the string is put into a bin, and the computer can view it as categorical data
...
knn_model_con <- train(x = data_to_train, #training data
                              ...
                              tuneGrid = data.frame(k = 2) #the hyperparameter, how many neighbors to look for
)
