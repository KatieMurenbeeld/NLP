...
species_colors <- c("Beavers" = "#005AB5", "Boars" = "#D41159", "Grizzly Bear" = "#994F00")
...
tidy_df %>%
  ...
  labs(title = paste("Document Sentiment: Articles About Beavers, Boars, and Grizzly Bears")) + 
...
sent_test %>%
  ...
  #scale_fill_manual(values=c("tan", "#994F00")) + # change the colors of the bar plot
  scale_fill_manual(values=species_colors) +
  geom_col(show.legend = FALSE) + 
  facet_wrap(~sentiment + Species , scales = "free_y", ncol = 2) +
...
#ggsave("test_sent_species2.png", width=10, height=6, dpi=300)
```
...
test_with_data <- plot_usmap('states') + 
  ...
  position=position_jitter(h=90000,w=50000)) + 
...
test_with_data
#ggsave("map_article_locations.png")
```
